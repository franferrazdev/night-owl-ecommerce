...
export function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm transition-opacity">
      ...
      {/* Painel do Carrinho */}
      <div className="relative w-full max-w-md h-full bg-[#0B0F19] border-l border-slate-900 shadow-2xl flex flex-col p-6 animate-slide-in-from-right duration-200">
        {/* Cabeçalho do Carrinho */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-900 text-slate-200">
